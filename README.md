...
- copier coller ce prompt + les tests et les donner à manger à une IA pour obtenir les règles du jeu (on peut aussi les trouver sur Internet, mais là vous aurez la variante du jeu sur laquelle je me suis basée, avec les règles dans un ordre intéressant pour être suivies en TDD)
